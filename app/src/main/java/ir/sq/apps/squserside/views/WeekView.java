package ir.sq.apps.squserside.views;
...
import static ir.sq.apps.squserside.views.WeekViewUtil.isSameDay;
import static ir.sq.apps.squserside.views.WeekViewUtil.today;
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEE", Locale.getDefault()) : new SimpleDateFormat("EEE", Locale.getDefault());
